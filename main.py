...
pygame.display.set_caption("A* pathyboi")
...
class Spot:
    ...
    def draw(self, window):
        pygame.draw.rect(window, self.color, (self.x, self.y, self.wid, self.wid))
    ...
    while not open_set.empty():
        ...
        for neighbor in current.neighbors:
            ...
            if temp_gscore < gscore[neighbor]:
                ...
                fscore[neighbor] = temp_gscore + h(neighbor.get_pos(), end.get_pos())
